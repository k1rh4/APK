...
#File-> 
    ...
    for target in targetStructure:
        ...
        if ( serachString(target['class_name']) ):
            OUTPUT.append("[+] class: [%s], perm: [%s] " %(target['class_name'], target['permission']))
...
if __name__ =="__main__":
    ...
    for file_name in files:
        OUTPUT=[]
        OUTPUT.append("===========================================================")
        OUTPUT.append("[*] Analysis : %s " %file_name)
        OUTPUT.append("===========================================================")
        #print("===========================================================")
